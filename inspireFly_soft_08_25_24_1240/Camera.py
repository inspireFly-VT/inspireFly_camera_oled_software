...
#     RESOLUTION_160X120 = 0X00
    ...
    RESOLUTION_640X480 = 0X02		#Resolution works
...
########### CORE PHOTO FUNCTIONS ###########
    def __init__(self, spi_bus, cs, skip_sleep=False, debug_information=False):
        ...
        self.current_resolution_setting = self.RESOLUTION_128X128 # ArduCam driver defines this as mode
    ...
    def capture_jpg(self):
        ...
        print("Current pixel format:", self.current_pixel_format)
        print("Current resolution:", self.current_resolution_setting)
...
#         print('rec len:', self.received_length)
        ...
        while(self.received_length):
            ...
            if (image_data_int == 0xff) and (image_data_next_int == 0xd8):	#Running into errors here
